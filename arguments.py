...
def get_argument_parser():
    ...
    parser.add_argument('--attn_type', default='t2i',
                        help='{t2i,i2t}')
    parser.add_argument('--t2i_smooth', default=9.0, type=float,
                        help='The value of t2i softmax lambda')
    parser.add_argument('--i2t_smooth', default=9.0, type=float,
                        help='The value of i2t softmax lambda')

    parser.add_argument('--bilateral', default=True, type=bool,
                        help='True|False')
    parser.add_argument('--trans_step', default=1, type=int,
                        help='{1,2,3}')
    parser.add_argument('--n_head', default=8, type=int,
                        help='{2,4,8,16}')
    parser.add_argument('--weight_norm', default="True",
                        help='True|False')
